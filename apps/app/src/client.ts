 ...
 */
import type { AgentAdvisory, AgentAskResponse, AgentCommandStatus, AgentStatus, RaceDayStatus, SpectatorNotice, PeopleQueryResult, Position, SessionInfo, SocketFrame, VenueGeometry } from "@crowdflow/contracts/wire";
