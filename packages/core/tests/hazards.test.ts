...
function pack(): CircuitPack {
  return {
    ...
    edges: {
      ab: { id: 'ab', source: 'a', destination: 'b', length_m: 10, width_m: measured(2), geometry: [{ x: 0, y: 0 }, { x: 10, y: 0 }] },
      bd: { id: 'bd', source: 'b', destination: 'd', length_m: 10, width_m: measured(2), geometry: [{ x: 10, y: 0 }, { x: 10, y: 10 }] },
      ac: { id: 'ac', source: 'a', destination: 'c', length_m: 12, width_m: measured(2), geometry: [{ x: 0, y: 0 }, { x: 0, y: 10 }] },
      cd: { id: 'cd', source: 'c', destination: 'd', length_m: 12, width_m: measured(2), geometry: [{ x: 0, y: 10 }, { x: 10, y: 10 }] },
    },
    crossings: {},
